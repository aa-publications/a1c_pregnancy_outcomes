...
clean_pred_df.loc[clean_pred_df['dm_before_supervision_code']=='no_dm', 'a1c'] = 4
...
pred_cols = ['GRID','dm_before_supervision_code','a1c','closest_ega','Race','DEP_INDEX','age_at_supervision']
...
for outcome in proxy_outcome_labels:
    ...
    # fml = f"{outcome} ~ dm_before_supervision_code_t1dm*a1c + dm_before_supervision_code_t2dm*a1c + age_at_supervision"
    print(fml)
